...
#endif
    EASY_BLOCK("ORB Extraction", profiler::colors::Blue500);
...
#endif
    EASY_BLOCK("ComputeStereoMatches", profiler::colors::Pink500);
...

{
    ...
    std::chrono::steady_clock::time_point time_StartStereoMatches = std::chrono::steady_clock::now();
#endif
    EASY_BLOCK("ComputeStereoFishEyeMatches", profiler::colors::Purple500);
