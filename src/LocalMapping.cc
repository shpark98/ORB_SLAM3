...
{
    EASY_BLOCK("LocalMapping",profiler::colors::Green);
    mbFinished = false;
    ...
    while(1)
    {
        ...
        if(CheckNewKeyFrames() && !mbBadImu)
        {
            ...
            EASY_BLOCK("ProcessNewKeyFrame",profiler::colors::Green);
            ProcessNewKeyFrame();
            EASY_END_BLOCK;
#ifdef REGISTER_TIMES
            ...
            EASY_BLOCK("MapPointCulling",profiler::colors::Green);
            MapPointCulling();
            EASY_END_BLOCK;
#ifdef REGISTER_TIMES
            ...
            EASY_BLOCK("CreateNewMapPoints",profiler::colors::Green);
            CreateNewMapPoints();
            ...
            if(!CheckNewKeyFrames() && !stopRequested())
            {
                ...
                EASY_BLOCK("KeyFrameCulling",profiler::colors::Green);
                KeyFrameCulling();
                EASY_END_BLOCK;
